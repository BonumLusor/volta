...
const styles = {
  "app.vue": () => import('./app-styles.CM17qeHP.mjs').then(interopDefault),
  "app.vue?vue&type=style&index=0&scoped=7ff6bbd1&lang.css": () => import('./app-styles.CM17qeHP.mjs').then(interopDefault),
